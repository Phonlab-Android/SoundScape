...
public class MusicActivity extends AppCompatActivity {
    ...
    //Each of our 8 image click methods calls requestAndImplementAudioFocus and passes in its raw file
    public void playHighC(View view){
        requestAndImplementAudioFocus(R.raw.high_c);
    }

    public void playB(View view){
        requestAndImplementAudioFocus(R.raw.b);
    }

    public void playA(View view){
        requestAndImplementAudioFocus(R.raw.a);
    }

    public void playG(View view){
        requestAndImplementAudioFocus(R.raw.g);
    }

    public void playF(View view){
        requestAndImplementAudioFocus(R.raw.f);
    }

    public void playE(View view){
        requestAndImplementAudioFocus(R.raw.e);
    }

    public void playD(View view){
        requestAndImplementAudioFocus(R.raw.d);
    }

    public void playLowC(View view){
        requestAndImplementAudioFocus(R.raw.low_c);
    }
